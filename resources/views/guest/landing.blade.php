    ...
    <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
        <div class="container">
            <div class="hero-container d-flex flex-column justify-content-start" data-aos="fade-in">
                <h1 class="text-left">
                    <a href="" style="text-decoration: none;color: #fff;font-size: 2.5rem;">{{ env('APP_NAME') }}</a>
                </h1>
                <p class="text-left" style="font-size: 1.3rem;">Tentang aplikasi <span class="typed" data-typed-items="kegunaan, tujuan, manfaat"></span></p>

                <div class="btn-toolbar justify-content-start" role="toolbar" aria-label="Toolbar with button groups">
                    <div class="btn-group me-2" role="group" aria-label="First group">
                        <a id="admin" class="btn btn-lg btn-warning d-flex justify-content-start align-items-center" style="font-size: 1.5rem; padding: 1rem 2rem;"
